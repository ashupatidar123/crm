...
@section('title') User Menu Permission @endsection
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header card_header_color">
                            <h3 class="card-title"><strong>{{strtoupper($user->first_name)}}</strong> ({{strtolower($user->email)}}) User Menu Permission</h3>
                        </div>
                        @if(!empty($all_menu))
                        <form method="POST">
                        ...
                        <ul class="tree">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="return user_permission();" id="applyPermissionLoader"><i class="fas fa-user-shield"></i> Apply Permission</button>
