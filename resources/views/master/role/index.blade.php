...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <button type="button" class="btn btn-sm btn-default" onclick="return add_edit_role('','add');"><i class="fa fa-plus" aria-hidden="true"></i> Add</button>
                    ...
                    <div class="modal-body">
                        <form method="POST" id="addFormId">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header card_header_color"><h3 class="card-title">Add/Edit Role</h3>
                                        </div>
                                        ...
                                        <div class="card-body row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <p class="text-danger" id="role_nameError"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Rank<span class="text-danger">*</span></label>
                                                    <input type="number" name="rank" id="rank" class="form-control" placeholder="Enter role rank">
