            ...
            <div class="col-12">
                ...
                <div class="card1 card-primary1">
                    <div class="search-form">
                        <form method="POST" id="userOtherDocumentSearch">
                            @csrf    
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-body row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-primary" onclick="return user_other_document_search();"><i class="fa fa-search"></i> Search</button>
                                                    <button type="button" class="btn btn-danger" onclick="return user_other_document_search_reset_form();"><i class="fa fa-refresh"></i> Reset</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
